object ContasAReceberForm: TContasAReceberForm
  Left = 0
  Top = 0
  ...
  object Panel2: TPanel
    ...
    object FormGroupBox: TGroupBox
      ...
      Height = 215
      Align = alClient
      Caption = 'Dados da conta a receber'
      TabOrder = 0
  ...
  object DataSource1: TDataSource
    DataSet = MainData.ContasAReceberDataSet
    Left = 720
    Top = 280
  end
end
