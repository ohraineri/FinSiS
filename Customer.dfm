object CustomerForm: TCustomerForm
  ...
  object CreateCustomerButton: TBitBtn
    Left = 8
    Top = 8
    Width = 129
    Height = 25
  ...
  object EditCustomerButton: TBitBtn
    Left = 176
    Top = 10
    Width = 129
    Height = 25
  ...
  object DeleteCustomerButton: TBitBtn
    Left = 328
    Top = 8
    Width = 129
    Height = 25
  ...
  object SearchCustomerInput: TEdit
    Left = 515
    Top = 11
    Width = 182
    Height = 21
    TabOrder = 4
    OnChange = SearchCustomerInputChange
  end
  object Panel1: TPanel
    ...
    Align = alBottom
    TabOrder = 5
    object CountCustomersLabel: TLabel
      Left = 5
      Top = 0
      Width = 121
      Height = 13
    ...
    object CustomerGrid: TDBGrid
      ...
      Columns = <
        ...
        item
          ...
          Title.Caption = 'Data de aniversario'
          Visible = True
        end
        item
          Expanded = False
  ...
  object Panel2: TPanel
    ...
    Align = alClient
    TabOrder = 6
    object CustomerFormGroupBox: TGroupBox
      Left = 1
      Top = 1
      Width = 776
      Height = 215
    ...
    object SaveCustomerFormButton: TBitBtn
      Left = 8
      Top = 129
      Width = 166
      Height = 25
      Caption = 'Salvar'
      TabOrder = 1
      OnClick = SaveCustomerFormButtonClick
    end
    object CancelCustomerFormButton: TBitBtn
      Left = 192
      Top = 129
      Width = 153
      Height = 25
      Caption = 'Cancel'
      TabOrder = 2
      OnClick = CancelCustomerFormButtonClick
    end
  end
